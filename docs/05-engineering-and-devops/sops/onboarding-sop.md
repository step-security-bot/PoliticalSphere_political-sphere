...
Applies to all new hires, contractors, and team transfers joining the development team.
...
- [ ] **Continuous Learning**: Access to training resources and conferences
...
- [ ] **Database Setup**: Configure local database instance
...
- [ ] **Data Handling**: Learn proper handling of sensitive data

## Success Metrics

- Time to first commit: < 1 week
- Time to first merged PR: < 2 weeks
- Time to full productivity: < 4 weeks
- Retention rate: > 90% at 6 months

## Mentor Responsibilities

- [ ] **Daily Check-ins**: First two weeks, then weekly
- [ ] **Code Reviews**: Guide through PR process
- [ ] **Knowledge Transfer**: Share tribal knowledge and best practices
- [ ] **Feedback Loop**: Provide constructive feedback on progress

## New Hire Responsibilities

- [ ] **Active Learning**: Ask questions and seek clarification
- [ ] **Documentation**: Update docs with any gaps found
- [ ] **Feedback**: Provide feedback on onboarding process
- [ ] **Engagement**: Participate actively in team activities

## Related Documentation

- [Development Environment Setup](../../05-engineering-and-devops/development/README.md)
- [Code Review SOP](./code-review-sop.md)
- [Security Standards](../../06-security-and-risk/security.md)

---

**Document Owner:** People Team
